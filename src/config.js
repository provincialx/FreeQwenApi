...
export const TASK_STATUS_URL =
  process.env.TASK_STATUS_URL || `${QWEN_BASE_URL}/api/v1/tasks/status`;
...
export const TASK_POLL_MAX_ATTEMPTS =
  Number(process.env.TASK_POLL_MAX_ATTEMPTS) || 90;
export const TASK_POLL_INTERVAL =
  Number(process.env.TASK_POLL_INTERVAL) || 2_000;
